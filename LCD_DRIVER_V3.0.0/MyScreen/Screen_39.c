...
void Screen_39_Movie(unsigned int Keyid)
{
    ...
    {
        lv_event_send(guider_ui.screen_39_btn_2, LV_EVENT_SHORT_CLICKED, NULL); // 加载界面screen_20
    ...
    else if (Keyid == KEYENTER_2S)
    {
        ...
        lv_event_send(guider_ui.screen_39_btn_2, LV_EVENT_CLICKED, NULL); // 加载界面screen_40
        current_screen = SCREEN_40;
