...
void Screen_76_Movie(unsigned int Keyid)
{
    ...
    {
        lv_event_send(guider_ui.screen_76_btn_2, LV_EVENT_SHORT_CLICKED, NULL); // 加载界面screen_14
    ...
    else if (Keyid == KEYENTER_2S)
    {
        ...
        lv_event_send(guider_ui.screen_76_btn_2, LV_EVENT_PRESSED, NULL); // 加载界面screen_77
        current_screen = SCREEN_77;
