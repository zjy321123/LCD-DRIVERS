...
void Screen_78_Movie(unsigned int Keyid)
{
    ...
    {
        lv_event_send(guider_ui.screen_78_btn_2, LV_EVENT_SHORT_CLICKED, NULL); // 加载界面screen_16
    ...
    else if (Keyid == KEYENTER_2S)
    {
        ...
        lv_event_send(guider_ui.screen_78_btn_2, LV_EVENT_PRESSED, NULL); // 加载界面screen_79
        current_screen = SCREEN_79;
